...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "csr"), encode_puzzle_hash(new_ph_2, "csr"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "csr"))
            ...
            assert config["farmer"]["xch_target_address"] == encode_puzzle_hash(new_ph, "csr")
            assert config["pool"]["xch_target_address"] == encode_puzzle_hash(new_ph_3, "csr")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "csr")
